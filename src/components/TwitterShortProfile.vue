...
<template>
    <article class="dt w-100 bb b--black-05 pb2 mt2" href="#0">
      ...
      <div class="dtc v-mid">
        <form class="w-100 tr" @submit.prevent="isFollowing">
          <button class="f6 button-reset bg-white ba b--black-10 dim pointer pv1 black-60" type="submit">{{superhero.isFollowing ? "unfollow" : "Follow"}}</button>
        </form>
      </div>
    </article>
</template>